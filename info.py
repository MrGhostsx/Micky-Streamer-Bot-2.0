...
SESSION = environ.get('SESSION', 'Webghostbot')  # Pyrogram client session name
...
OWNER_USERNAME = environ.get("OWNER_USERNAME", 'AlphDragon')  # Owner's username
BOT_USERNAME = environ.get("BOT_USERNAME", 'MovieStreamsBot')  # Bot's username

# 🔗 Channel & Support Links
CHANNEL = environ.get('CHANNEL', 'https://t.me/Tech_Shreyansh1')  # Updates channel
SUPPORT = environ.get('SUPPORT', 'https://t.me/AboutsShreyansh')  # Support group
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'd73e70a35dc3877fa25afbf51fa8ec312c98580c')  # API key for shortlink

# 💾 MongoDB Connection Information
DB_URL = environ.get('DATABASE_URI', "mongodb+srv://ghost:ghost@cluster0p1.mongodb.net/?rites=truity&appName=Cluster0")  # MongoDB connection URI
DB_NAME = environ.get('DATABASE_NAME', "cluster0")  # MongoDB database name

# 📸 all Media (Images)
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/svXQZCSY/Uploaded-8063565025.jpg')  # QR Code image
VERIFY_IMG = environ.get("VERIFY_IMG", "https://i.ibb.co/DDQ3H0tS/Uploaded-8063565025.png")  # Verify success image
AUTH_PICS = environ.get('AUTH_PICS', 'https://i.ibb.co/zTcPStWD/Uploaded-8063565025.jpg')  # Auth step image
PICS = environ.get('PICS', 'https://envs.sh/_pM.jpg')  # Default info image
FILE_PIC = environ.get('FILE_PIC', 'https://i.ibb.co/zhgRs8Ph/Uploaded-8063565025.jpg') # file image 
...
name = str(environ.get('name', 'mrghost'))  # Project name
APP_NAME = None
if 'DYNO' in environ:
    ON_HEROKU = True
